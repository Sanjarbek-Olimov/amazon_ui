...
class AmazonOld2 extends StatefulWidget {
  static const String id = "amazon_old_2";

  const AmazonOld2({Key? key}) : super(key: key);

  @override
  _AmazonOld2State createState() => _AmazonOld2State();
}

class _AmazonOld2State extends State<AmazonOld2> {
