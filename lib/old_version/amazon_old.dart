...
class AmazonOld extends StatefulWidget {
  static const String id = "amazon_old";

  const AmazonOld({Key? key}) : super(key: key);

  @override
  _AmazonOldState createState() => _AmazonOldState();
}

class _AmazonOldState extends State<AmazonOld> {
  @override
